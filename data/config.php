...
$USER_QUERY = "QUERYUSER"; //Usuario de conexion a query
$PASS_QUERY = "QUERYPASS"; //Clave generada para a conexion query
...
$DEBUG = false; //Activa los mensajes de error detallados
